...
interface ClientAccountStatsCardsProps {
...
export function ClientAccountStatsCards({
  totalInvoices,
  totalReceivable,
  totalOverdue,
  totalPaid,
  formatCurrency,
}: ClientAccountStatsCardsProps) {
  console.log('ClientAccountStatsCards props:', { totalInvoices, totalReceivable, totalOverdue, totalPaid });
